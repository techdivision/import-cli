...
abstract class AbstractImportCommand extends Command
{
    ...
    protected function configure()
    {
        ...
        $this->addOption(InputOptionKeys::SERIAL, null, InputOption::VALUE_REQUIRED, 'The unique identifier of this import process', Uuid::uuid4()->__toString())
             ...
             ->addOption(InputOptionKeys::CACHE_ENABLED, null, InputOption::VALUE_REQUIRED, 'Whether or not the cache functionality for the import should be enabled', false)
             ...
             ->addOption(InputOptionKeys::DB_TABLE_PREFIX, null, InputOption::VALUE_REQUIRED, 'The table prefix used by the Magento database')
